...
public class FileCarshHandler implements Thread.UncaughtExceptionHandler {
     ...
     * @param context
     */
    public void regitster(Context context) {
        mContext = context;
    ...
    private boolean handleException(Throwable ex) {
        ...
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
                Toast.makeText(mContext, "很抱歉，出错了", Toast.LENGTH_LONG).show();
                Looper.loop();
            }
        }.start();
        // 收集设备参数信息
    ...
    private String saveCrash2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                ...
                String sdCardPath = sdCardFile.getAbsolutePath() + "/"+packageName+"/crash/";
                ...
                Log.e(TAG, "crash info :" + crashInfo);
                Log.i(TAG, "crash信息已保存到sdcard:" + sdCardPath);
            }
            return fileName;
        } catch (Exception e) {
